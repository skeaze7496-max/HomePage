<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.memberone.StudentVO" %>
<jsp:useBean id="dao" class="com.memberone.StudentDAO"></jsp:useBean> <!--자바빈써서 정보 가져옴  -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<form action="modifyProc.jsp" method="post" name="regForm">
	<table border="1">
		...
		<tr>
			...
			<input type="button" value="회원정보 수정" onclick="updateCheck()">&nbsp;&nbsp;
