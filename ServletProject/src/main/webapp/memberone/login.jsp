...
<body>
<% if(loginID != null){ //로그인이 되었을경우%>
<table>
	<tr>
		<td colspan="3" align="center"><%=loginID %>님 환영합니다.</td>
	</tr>
	<tr>
		<td width="130" align="center"><a href="modifyForm.jsp">정보수정</a></td>
		<td width="130" align="center"><a href="deleteProc.jsp">회원탈퇴</a></td>
		<td width="130" align="center"><a href="Logout.jsp">로그아웃</a></td>
	</tr>
</table>
<%} else {//로그인 실패시 %>
